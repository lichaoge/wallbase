...
CREATE TABLE `tb_wallpaper` (
  ...
  `purity` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '图片纯洁度',
  ...
  `thumb_url` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT '缩略图ULR',
  `image_url` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT '原图UR',
